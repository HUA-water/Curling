        ...
        if int(state_list[1]) == 0:
            ...
            if int(state_list[1]) == 14:
                if my_sort_res(all_num, state_list)[0][1]%4 == 0:
                    ...
                    v = float(3.613 - 0.12234 * float(state_list[0][my_sort_res(second_num, state_list)[0][1] + 1]) + 4)
                    h_x = float(float(state_list[0][my_sort_res(second_num, state_list)[0][1]]) - 2.375)
                    angle = float(0.0)
                    flag = 0
            else:
                v = float(3.613 - 0.12234 * float(state_list[0][my_sort_res(second_num, state_list)[0][1] + 1]) + 4)
                ...
                angle = float(0.0)
                flag = 0
        if (len(res) >= 2) and (my_sort_res(all_num, state_list)[0][1] % 4 == 0) and (my_sort_res(all_num, state_list)[1][1] == 0):
            target = [float(state_list[0][my_sort_res(all_num, state_list)[0][1]]), float(state_list[0][my_sort_res(all_num, state_list)[0][1] + 1]) + 2]
            v = float(3.613 - 0.12234 * target[1])
            h_x = float(target[0] - 2.375)
            angle = float(0.0)
        ...
        if int(state_list[1]) == 1:
            ...
            if int(state_list[1]) == 13:
                if my_sort_res(all_num, state_list)[0][1] % 4 == 2:
                    ...
                    v = float(3.613 - 0.12234 * float(state_list[0][my_sort_res(first_num, state_list)[0][1] + 1]) + 4)
                    h_x = float(float(state_list[0][my_sort_res(first_num, state_list)[0][1]]) - 2.375)
                    angle = float(0.0)
                    flag = 0
            else:
                v = float(3.613 - 0.12234 * float(state_list[0][my_sort_res(first_num, state_list)[0][1] + 1]) + 4)
                ...
                angle = float(0.0)
                flag = 0
        if (len(res) >= 2) and (my_sort_res(all_num, state_list)[0][1] % 4 == 2) and (my_sort_res(all_num, state_list)[1][1] == 2):
            target = [float(state_list[0][my_sort_res(all_num, state_list)[0][1]]), float(state_list[0][my_sort_res(all_num, state_list)[0][1] + 1]) + 2]
            v = float(3.613 - 0.12234 * target[1])
            h_x = float(target[0] - 2.375)
            angle = float(0.0)
...
while True:
    ...
    if messageList[0] == "ISREADY":
        ...
        print("send READYOK")
        obj.send(bytes("NAME NewSample", encoding="utf-8"))
        print("send NAME NewSample")
